...
for marker in \
  ...
  '^USER:ENTER_EL0' \
  '^USER:HELLO' \
  '^USER:BAD_POINTER_REJECTED' \
  '^USER:BAD_SYSCALL_REJECTED' \
  '^USER:HEAP_PAGES=0x0000000000000001' \
  '^USER:HEAP_LIMIT_ENFORCED' \
  '^USER:YIELD' \
  '^USER:UART_DENIED' \
  '^USER:KERNEL_DENIED' \
  '^USER:FAULTS_OK' \
  '^USER:EXIT=0x0000000000000000' \
  ...
  '^USER:PREEMPTIONS=0x0000000000000*[1-9a-f]' \
